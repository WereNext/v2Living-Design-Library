    ...
    <ShowcaseWithNav sections={sections}>
      ...
      >
        <div className="bg-card rounded-lg overflow-hidden border">
          ...
          <div className="max-w-4xl mx-auto px-md sm:px-lg lg:px-xl py-xl sm:py-xl lg:py-2xl">
            {/* Category & Reading Time */}
            <div className="flex items-center gap-sm sm:gap-md mb-md sm:mb-lg">
              <Badge variant="outline" className="text-xs sm:text-sm px-xs sm:px-sm py-1">
                Culture
              </Badge>
            ...
            {/* Headline */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-md sm:mb-lg leading-tight">
              The Future of Editorial Design in the Digital Age
            </h1>

            {/* Dek (subheadline) */}
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-lg sm:mb-xl leading-relaxed">
            ...
            {/* Byline */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-md border-t border-b py-md mb-lg">
      ...
      >
        <div className="relative bg-gradient-to-br from-foreground via-foreground/95 to-foreground/90 text-background rounded-lg overflow-hidden min-h-[600px] flex items-center">
          ...
          <div className="relative z-10 w-full px-md sm:px-lg lg:px-2xl py-2xl sm:py-16">
            {/* Issue Label */}
            <div className="mb-lg sm:mb-xl">
              <div className="inline-block px-sm sm:px-md py-1.5 sm:py-xs border-2 border-background">
                <div className="text-xs tracking-widest uppercase">Winter 2025 Issue</div>
              </div>
            </div>

            {/* Cover Headline */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-lg sm:mb-xl leading-[0.9] tracking-tight">
              The Art of Storytelling
            </h1>

            {/* Cover Dek */}
            <p className="text-lg sm:text-xl md:text-2xl mb-xl sm:mb-2xl opacity-90 leading-relaxed max-w-4xl">
              Inside the creative process of today's most influential writers and editors
            </p>

            {/* Additional Stories */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-md sm:gap-lg border-t-2 border-background pt-lg sm:pt-xl max-w-5xl">
              {[
                ...
                <div key={i} className="opacity-75 hover:opacity-100 transition-opacity cursor-pointer">
                  <div className="text-xs tracking-widest uppercase mb-xs opacity-60">
                    Page {(i + 1) * 24}
                  </div>
      ...
      >
        <div className="bg-destructive text-destructive-foreground rounded-lg px-md sm:px-lg lg:px-xl py-md sm:py-lg mb-md">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-xs sm:gap-sm">
        ...
        <div className="bg-card border rounded-lg p-md sm:p-lg lg:p-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-sm sm:gap-md mb-md sm:mb-lg">
            <Badge>Technology</Badge>
            <span className="text-xs sm:text-sm text-muted-foreground">Updated 5 minutes ago</span>
          </div>

          <h2 className="text-2xl sm:text-3xl lg:text-4xl mb-md sm:mb-lg leading-tight">
            Industry Leaders Announce New Standards for Editorial Design Systems
          </h2>

          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-lg sm:mb-xl leading-relaxed">
          ...
          <div className="flex items-center gap-sm pb-md sm:pb-lg border-b mb-md sm:mb-lg">
          ...
          <div className="space-y-sm sm:space-y-md">
            {[
              ...
              <div key={i} className="flex flex-col sm:flex-row gap-xs sm:gap-md text-xs sm:text-sm">
          ...
          <Button className="mt-xl" onClick={() => toast.success("Following story...")}>
            Follow This Story
            <ArrowRight className="ml-xs w-4 h-4" />
          </Button>
        </div>
